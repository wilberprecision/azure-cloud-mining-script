 ...
 * Example of how it works for the default setting of 0.0:
 * You miner will mine into your usual pool for 98 minutes, then switch to the developer's pool for 0.0 minute.
